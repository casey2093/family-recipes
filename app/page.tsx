  ...
  return (
    <>
      ...
      <div className="hidden sm:block sm:sticky sm:top-16 sm:overflow-hidden" style={{ height: "calc(100vh - 64px)", zIndex: 0, backgroundColor: "#f0f9ff" }}>
        {/* Photo */}
        <div className="absolute inset-x-0 bottom-0" style={{ top: "18.5%" }}>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            src="/family-hero.jpg"
            alt="The Ware Family"
        ...
        {/* Sky-blue text panel */}
        <div
          className="absolute inset-x-0 top-0 z-10 flex flex-col items-center justify-start px-6 text-center pt-0"
          style={{
            height: "44%",
            background:
              "linear-gradient(to bottom, #f0f9ff 0%, #f0f9ff 72%, rgba(240,249,255,0.75) 82%, rgba(240,249,255,0.4) 92%, transparent 100%)",
          }}
        >
          <h1
          ...
          <p className="text-gray-600 text-base sm:text-lg max-w-2xl mx-auto mb-3 leading-relaxed whitespace-nowrap">
            The best recipes from every corner of the family, lovingly collected right here.
          </p>
